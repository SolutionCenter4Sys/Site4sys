...
const FAQS = [
  ...
  },
  {
    ...
    a: 'Nosso modelo é focado em valor em semanas, não em meses. Para Squads Híbridas, os primeiros entregáveis acontecem na segunda semana. Para IA com ROI, o business case com impacto projetado sai em 4 a 6 semanas. Para Modernização de Legado, o primeiro módulo piloto opera em 8 a 12 semanas.',
  },
  {
